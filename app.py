...
# Chatbot using Llama 3.2-1B via Ollama
...
if user_query:
    if st.session_state['user_profile'] is not None:
        ...
        prompt = (
            f"You are a health assistant. Here’s the user’s profile:\n{profile_str}\n"
            f"The user asked: '{user_query}'\nProvide a concise, personalized, and actionable response."
        )
        ...
        try:
            ...
            response = f"Sorry, I couldn’t process that right now due to: {e}. Try again!"
